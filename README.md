...
# 📖 Code_review_Project <a name="about-project"></a>

**Code_review_Project**  is a project introduction to the code review process 
...
```sh
  cd my-folder
  git clone https://github.com/abenezer-addisu/Code_review_Project.git
```
